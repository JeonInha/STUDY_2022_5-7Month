...
import busan2044_MethodTest.ChoiceSum;
import busan2044_MethodTest.Story;
...
public class StoryPnl extends JFrame {
	...
	// TODO 대수한테 BusanUser 받기로 했단 거 꼭 알려주기!!!!!!!!!
	...
	private void insertPath(BusanUser loguser, String path) {
		Connection conn = null;
		PreparedStatement pstmt = null;
		String qInsert = "INSERT INTO savehere(storyPath) VALUES (?)";
